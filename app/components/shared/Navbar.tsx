...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center py-4 px-8 sm:px-12 lg:px-16">
        ...
        <div className="flex items-center justify-between bg-white/70 dark:bg-black/50 backdrop-blur-lg border border-gray-200 dark:border-gray-800 rounded-full px-6 h-16">
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-800 focus:outline-none"
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg rounded-xl border border-gray-200 dark:border-gray-800">
              {[...navItems, contactItem].map((item) => (
                <Link
                  ...
                  className="text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-black dark:hover:text-white block px-3 py-2 rounded-md text-base font-medium transition-colors"
                >
                  {item.name}
                </Link>
              ))}
